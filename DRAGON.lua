...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝒌𝒂𝒔𝒂𝒃 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝒌𝒂𝒔𝒂𝒃 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝒌𝒂𝒔𝒂𝒃 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if tonumber(user_id) == tonumber(1204173076) then  
var = true  
elseif tonumber(user_id) == tonumber(1204173076) then
var = true  
elseif tonumber(user_id) == tonumber(1204173076) then
var = true  
...
local UserName = (data.username_ or "MuHaMeD_KaSsAb")
...
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس كسٱب\n ℘︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس كسٱب \n ℘︙ الاصدار »{ v 1.6 }')
end
...
-------------
if text == " حصريات و تحديثات كسآب " and DevSoFi(msg) then  
local updatech =[[
...
{{text = '📂┇𝒌𝒂𝒔𝒂𝒃 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/MuHaMeD_KaSsAb"}},
}
